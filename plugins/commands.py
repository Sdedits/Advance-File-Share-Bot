...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton("Main Channel", url="https://t.me/teamvishwas"),
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 Subscribe Official Channel 💗', url=f'https://t.me/teamvishwas')
            ],[
            InlineKeyboardButton('♻️ Back-Up Channel ♻️', url=f'https://t.me/teamvishwasofficial')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help", "start", "hehe"]:
        ...
        buttons = [[
            InlineKeyboardButton('💝 Main Channel 💗', url=f'https://t.me/teamvishwas')
            ],[
            InlineKeyboardButton('♻️ Back-Up Channel ♻️', url=f'https://t.me/teamvishwasofficial')
            ],[
            InlineKeyboardButton('ℹ️ Owner', url=f't.me/Shivbhakt15'),
        ...
        for msg in msgs:
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("🍿 Official Channel 🍿", url="https://t.me/teamvishwasofficial")] ] ),
